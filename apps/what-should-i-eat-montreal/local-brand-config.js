/**
 * Montreal Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Montreal Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (Montreal red)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
      ...
      wheelSegmentColor5: {
        ...
        type: 'color',
        description: 'Fifth segment color (oak brown)',
        default: 'inherited',
      },
      wheelSegmentColor6: {
