/**
 * London Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * London Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (London red)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
        label: 'Wheel Segment 2',
        type: 'color',
        description: 'Second segment color (navy)',
        default: 'inherited',
      },
      wheelSegmentColor3: {
      ...
      wheelSegmentColor4: {
        ...
        type: 'color',
        description: 'Fourth segment color (brick)',
        default: 'inherited',
      },
      wheelSegmentColor5: {
      ...
      wheelSegmentColor6: {
        ...
        type: 'color',
        description: 'Sixth segment color (Sandringham green)',
        default: 'inherited',
      },
      wheelSegmentColor7: {
