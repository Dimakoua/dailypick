/**
 * Guangzhou Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Guangzhou Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (Canton gold)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
      ...
      wheelSegmentColor4: {
        ...
        type: 'color',
        description: 'Fourth segment color (river blue)',
        default: 'inherited',
      },
      wheelSegmentColor5: {
