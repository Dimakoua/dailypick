/**
 * Austin Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Austin Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (Austin red)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
      ...
      wheelSegmentColor6: {
        ...
        type: 'color',
        description: 'Sixth segment color (green)',
        default: 'inherited',
      },
      wheelSegmentColor7: {
