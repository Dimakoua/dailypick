/**
 * Miami Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Miami Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (Miami orange)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
      ...
      wheelSegmentColor3: {
        ...
        type: 'color',
        description: 'Third segment color (sunny gold)',
        default: 'inherited',
      },
      wheelSegmentColor4: {
        label: 'Wheel Segment 4',
        type: 'color',
        description: 'Fourth segment color (coral)',
        default: 'inherited',
      },
      wheelSegmentColor5: {
        label: 'Wheel Segment 5',
        type: 'color',
        description: 'Fifth segment color (sea green)',
        default: 'inherited',
      },
      wheelSegmentColor6: {
        label: 'Wheel Segment 6',
        type: 'color',
        description: 'Sixth segment color (sun glow)',
        default: 'inherited',
      },
      wheelSegmentColor7: {
