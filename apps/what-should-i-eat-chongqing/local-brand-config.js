/**
 * Chongqing Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Chongqing Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (spice red)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
