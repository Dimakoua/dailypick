/**
 * Chinese Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Chinese Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (imperial red)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
      ...
      wheelSegmentColor3: {
        ...
        type: 'color',
        description: 'Third segment color (deep crimson)',
        default: 'inherited',
      },
      wheelSegmentColor4: {
        label: 'Wheel Segment 4',
        type: 'color',
        description: 'Fourth segment color (saffron gold)',
        default: 'inherited',
      },
      wheelSegmentColor5: {
        label: 'Wheel Segment 5',
        type: 'color',
        description: 'Fifth segment color (jade green)',
        default: 'inherited',
      },
      wheelSegmentColor6: {
        label: 'Wheel Segment 6',
        type: 'color',
        description: 'Sixth segment color (porcelain blue)',
        default: 'inherited',
      },
      wheelSegmentColor7: {
      ...
      wheelSegmentColor8: {
        ...
        type: 'color',
        description: 'Eighth segment color (dynasty purple)',
        default: 'inherited',
      },
      resultTextColor: {
        label: 'Result Text',
