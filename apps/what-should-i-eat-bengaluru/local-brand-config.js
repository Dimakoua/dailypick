/**
 * Bengaluru Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Bengaluru Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (garden green)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
        label: 'Wheel Segment 2',
        type: 'color',
        description: 'Second segment color (spice orange)',
        default: 'inherited',
      },
      wheelSegmentColor3: {
      ...
      wheelSegmentColor4: {
        ...
        type: 'color',
        description: 'Fourth segment color (brick red)',
        default: 'inherited',
      },
      wheelSegmentColor5: {
        label: 'Wheel Segment 5',
        type: 'color',
        description: 'Fifth segment color (sunshine yellow)',
        default: 'inherited',
      },
      wheelSegmentColor6: {
        label: 'Wheel Segment 6',
        type: 'color',
        description: 'Sixth segment color (deep blue)',
        default: 'inherited',
      },
      wheelSegmentColor7: {
      ...
      wheelSegmentColor8: {
        ...
        type: 'color',
        description: 'Eighth segment color (coffee brown)',
        default: 'inherited',
      },
      resultTextColor: {
        label: 'Result Text',
