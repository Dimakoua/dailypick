/**
 * Chengdu Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Chengdu Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (Sichuan red)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
        label: 'Wheel Segment 2',
        type: 'color',
        description: 'Second segment color (chili orange)',
        default: 'inherited',
      },
      wheelSegmentColor3: {
        label: 'Wheel Segment 3',
        type: 'color',
        description: 'Third segment color (deep purple)',
        default: 'inherited',
      },
      wheelSegmentColor4: {
      ...
      wheelSegmentColor5: {
        ...
        type: 'color',
        description: 'Fifth segment color (river blue)',
        default: 'inherited',
      },
      wheelSegmentColor6: {
      ...
      wheelSegmentColor8: {
        ...
        type: 'color',
        description: 'Eighth segment color (chili brown)',
        default: 'inherited',
      },
      resultTextColor: {
        label: 'Result Text',
