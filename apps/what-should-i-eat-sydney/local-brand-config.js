/**
 * Sydney Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Sydney Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (Sydney blue)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
      ...
      wheelSegmentColor4: {
        ...
        type: 'color',
        description: 'Fourth segment color (sea green)',
        default: 'inherited',
      },
      wheelSegmentColor5: {
        label: 'Wheel Segment 5',
        type: 'color',
        description: 'Fifth segment color (coral)',
        default: 'inherited',
      },
      wheelSegmentColor6: {
        label: 'Wheel Segment 6',
        type: 'color',
        description: 'Sixth segment color (harbour navy)',
        default: 'inherited',
      },
      wheelSegmentColor7: {
      ...
      wheelSegmentColor8: {
        ...
        type: 'color',
        description: 'Eighth segment color (sand brown)',
        default: 'inherited',
      },
      resultTextColor: {
        label: 'Result Text',
