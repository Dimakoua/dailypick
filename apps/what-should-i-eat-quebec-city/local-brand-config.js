/**
 * Quebec City Food Wheel - Local Brand Studio Configuration
 *
 * Allows customizing wheel segment colors and UI colors specific to the
 * Quebec City Food Wheel. Include this script BEFORE local-brand-studio.js loads.
 */
  ...
  window.LocalBrandStudioConfig = {
    customizableProperties: {
      ...
      wheelSegmentColor1: {
        ...
        type: 'color',
        description: 'First segment color (Quebec red)',
        default: 'inherited',
      },
      wheelSegmentColor2: {
      ...
      wheelSegmentColor4: {
        ...
        type: 'color',
        description: 'Fourth segment color (maple)',
        default: 'inherited',
      },
      wheelSegmentColor5: {
        label: 'Wheel Segment 5',
        type: 'color',
        description: 'Fifth segment color (brown)',
        default: 'inherited',
      },
      wheelSegmentColor6: {
