...
*   **Fast:** What helped us speed up or achieve our goals quickly?
*   **Slow:** What slowed us down or impeded our progress?
*   **Roadblocks:** What obstacles did we encounter that completely stopped us?
*   **Accelerator:** What can we do more of or introduce to go even faster next time?
...
*   **Rose:** What went well? What were our successes and highlights?
*   **Bud:** What has potential for growth? What new ideas or practices are emerging?
*   **Thorn:** What challenges did we face? What stung or caused difficulty?
...
*   **Wind:** What propelled us forward? (e.g., strong teamwork, new tool)
*   **Anchor:** What held us back or slowed our progress? (e.g., technical debt, unclear requirements)
*   **Rocks:** What risks did we encounter or foresee? (e.g., upcoming deadlines, resource constraints)
*   **Island:** What is our vision or goal? (A reminder of what we're striving for)
...
*   **Randomize Discussion Order:** After collecting feedback, instead of letting the most vocal person kick off, use Daily Pick's **Decision Wheel** or **List Picker** to randomly select who shares their thoughts first, or which specific feedback item gets discussed. This subtly encourages everyone to be prepared and creates a sense of anticipation.
*   **"Round Robin" with a Twist:** For specific questions, go around the virtual or physical room. If someone says "pass," that's fine, but ensure the opportunity is offered equally.
...
*   **Fair Assignment with Daily Pick:** List out the identified action items. Then, list the team members. Use Daily Pick's **Decision Wheel** to randomly assign ownership of action items. This fosters shared responsibility and ensures that everyone contributes to the team's continuous improvement. Of course, allow for a quick "pass and trade" if someone genuinely cannot take on a task, but the initial random assignment sets a tone of shared accountability.
*   **"Two Owners" Approach:** For critical items, assign two owners—one primary, one secondary—to ensure follow-through and shared learning.
