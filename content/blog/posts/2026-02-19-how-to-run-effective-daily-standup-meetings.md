...
keywords: how to run standups, daily standup format, effective standups, standup best practices
ogImage: /assets/og-image-main.png
ogImageAlt: Team running an effective standup meeting in a huddle
twitterImage: /assets/og-image-main.png
twitterImageAlt: Team running an effective standup meeting in a huddle
robots: index,follow
...
Bad standups waste time. Good standups save time—and unblock entire projects.

A single bad standup can ripple through your entire sprint:
- **10 minute blocker** → discovered during standup instead of wasting 2 days
- **One person stuck** → immediately pairs with someone who knows the solution
- **Silos break down** → people realize what others are building and find collaboration opportunities
- **Quick wins get celebrated** → team morale compounds
...
### The Core Purpose:
- **Synchronize** → Everyone knows the team's status
- **Surface blockers early** → Remove roadblocks before they derail sprints
- **Coordinate** → Identify collaboration opportunities across the team
- **Build cohesion** → Daily touchpoint that keeps teams connected
...
├─ Person 1: Yesterday/Today/Blockers (~90 sec)
├─ Person 2: Yesterday/Today/Blockers (~90 sec)
├─ Person 3: Yesterday/Today/Blockers (~90 sec)
└─ ... continue for each team member

Wrap-up (1-2 minutes)
├─ Facilitator notes key blockers
├─ Assign ownership for unblocking
└─ "See you tomorrow!"
```
...
- ✅ Finished feature X
- ✅ Reviewed PR from teammate
- ✅ Deployed to staging

**TODAY: What you're working on**
- 🔨 Building feature Y
- 🔨 Researching database optimization
- 🔨 Pair programming with Sarah on API
...
| **15 minutes** | ✅ Forces discipline; keeps energy high; 90 sec per person scales to 8 people |
...
**Good answers:**
- ✅ "Merged the authentication feature to main"
- ✅ "Reviewed 3 PRs and unblocked teammates"
- ✅ "Documented the API migration steps"
...
**Good answers:**
- ✅ "Building the search filter UI component"
- ✅ "Investigating the performance regression in database queries"
- ✅ "Pair programming with James on the payment integration"
...
**Good blockers:**
- ✅ "Waiting for design mockups from Amy to build the UI"
- ✅ "The staging environment has an SSL cert error—can't test the full flow"
- ✅ "Need code review on PR #442 before I can merge"
- ✅ "Unclear on the technical approach for this requirement"
...
- **90 seconds per person** — feels fair to everyone
...
**Format:**
1. **Blockers first** (2 min) — Surface what needs unblocking immediately
2. **Quick wins** (1 min) — Celebrate progress
...
**Why it happens:**
- No visible timer → people lose track of time
- Facilitator lets conversations drift → "Actually, about that API..."
- Too large a team → 10 people * 2 min each = 20 min minimum
...
- [ ] If most people pass → maybe standups aren't adding value → revisit the goal
...
**Fix:**
- [ ] **Rotate facilitatorships** — Devs, PMs, QA all take turns
...
**What happens:** "I've been blocked for 3 days." → Response: "Yeah, that sucks." → Next day, same blocker.
...
- [ ] **Protect standup time** — keep it a status sync, not a problem-solving workshop
...
**Fix:**
- [ ] **Randomize order** — Use a random name picker or spinner each day
- [ ] **Rotate by default** — Go alphabetical, then reverse, then geography-based
- [ ] **Try tools:** Use [Daily Pick's Speedway Racer](/apps/speedway/) or [Decision Wheel](/apps/wheel/) to gamify selection
...
### ✅ Signs Your Standup is Effective

- **People show up on time** → They see value
- **No repeated blockers** → Issues get unblocked quickly
- **People mention blockers early** → Psychological safety is high
- **Cross-team collaboration increases** → People learn about each other's work
- **Fewer surprises mid-sprint** → Alignment is happening
- **Team seems less stressed** → People know what's happening

### ❌ Signs Your Standup Isn't Working

- **People show up late** → They don't prioritize it
- **Same blockers for days** → Action isn't happening
- **People rarely speak** → Psychological safety is low
- **Conversations derail** → Format isn't enforced
- **Meetings regularly run 20+ min** → Too much content or too many people
- **People escape to Slack instead** → Async might be better
...
2. [ ] Track blockers—are they getting unblocked?
3. [ ] If standups are too long, split into multiple crews
4. [ ] If energy is low, try a different format from our [8 standup ideas guide](/blog/8-best-standup-meeting-ideas/)

### If Standups Still Aren't Working:
1. [ ] Consider async-first (especially for distributed teams)
2. [ ] Revisit the goal—maybe your team doesn't need standups yet
...
Start this week. You've got the blueprint. 🚀
